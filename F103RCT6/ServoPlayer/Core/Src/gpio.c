...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_R_Pin|LED_G_Pin|LED_B_Pin|WLM_SET_Pin
                          |WLM_FUNC_Pin|CS_Accel_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : WLM_SET_Pin WLM_FUNC_Pin CS_Accel_Pin */
  GPIO_InitStruct.Pin = WLM_SET_Pin|WLM_FUNC_Pin|CS_Accel_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : VBat_Sample_Enable_Pin */
  GPIO_InitStruct.Pin = VBat_Sample_Enable_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(VBat_Sample_Enable_GPIO_Port, &GPIO_InitStruct);
