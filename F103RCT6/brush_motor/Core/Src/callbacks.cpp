...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim) {
  if (htim->Instance == TIM6) {
    ...
    float result0 = pid0.Update(
        static_cast<float>(/*round_speed + */ target_speed), speed0);
    ...
    auto sent_result =
        community.SendMotorSpeed(0x000, mailbox, static_cast<int16_t>(speed0),
                                 target_speed, static_cast<int16_t>(result0));
