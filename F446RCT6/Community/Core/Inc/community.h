...
public:
   ...
   */
  Community(CAN_HandleTypeDef *hcan, Community_RxCallback rxCallback)
   ...
   * @return 发送状态
   */
  HAL_StatusTypeDef SendMotorSpeed(uint16_t canId, uint32_t *mailbox,
                                   int16_t speed, int16_t target, int16_t round,
                                   int16_t pidOut);
