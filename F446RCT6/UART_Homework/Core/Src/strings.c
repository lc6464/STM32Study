...
int int64ToString(int64_t x, char *output)
{
    ...
    int32_t high = (int32_t)(x / 1000000000),
        low = (int32_t)(x % 1000000000);

    char highString[11];
    char lowString[11];

    int highStringLength = int32ToString(high, highString, 0),
        lowStringLength;
    ...
    return highStringLength + lowStringLength + isNegative; // 千万别把 isNegative 漏掉了
}
