...
typedef uint16_t (*I2C_Transmit_t)(void *hi2c, uint16_t DevAddress,
                                   uint8_t *pData, uint16_t Size,
                                   uint32_t Timeout);
typedef uint16_t (*I2C_Receive_t)(void *hi2c, uint16_t DevAddress,
                                  uint8_t *pData, uint16_t Size,
                                  uint32_t Timeout);
typedef uint16_t (*I2C_Mem_Read_t)(void *hi2c, uint16_t DevAddress,
                                   uint16_t MemAddress, uint16_t MemAddSize,
                                   uint8_t *pData, uint16_t Size,
                                   uint32_t Timeout);
typedef uint16_t (*I2C_Mem_Write_t)(void *hi2c, uint16_t DevAddress,
                                    uint16_t MemAddress, uint16_t MemAddSize,
                                    uint8_t *pData, uint16_t Size,
                                    uint32_t Timeout);
...
#define Hardware_I2C_Register(I2C_Handle, hi2c_)                               \
  SEML_I2C_Register(I2C_Handle, hi2c_, HAL_I2C_Master_Transmit,                \
                    HAL_I2C_Master_Receive, HAL_I2C_Mem_Write,                 \
                    HAL_I2C_Mem_Read)
#endif
...
#define Software_I2C_Register(I2C_Handle, hi2c_)                               \
  SEML_I2C_Register(I2C_Handle, hi2c_, Software_I2C_Transmit,                  \
                    Software_I2C_Receive, Software_I2C_Mem_Write,              \
                    Software_I2C_Mem_Read)
