...
typedef uint16_t (*SPI_Transmit_t)(void *hspi, uint8_t *pData, uint16_t Size,
                                   uint32_t Timeout);
typedef uint16_t (*SPI_Receive_t)(void *hspi, uint8_t *pData, uint16_t Size,
                                  uint32_t Timeout);
typedef uint16_t (*SPI_TransmitReceive_t)(void *hspi, uint8_t *pTxData,
...
#define Hardware_SPI_Register(SPI_Handle, hspi_)                               \
  SEML_SPI_Register(SPI_Handle, hspi_, HAL_SPI_Transmit, HAL_SPI_Receive,      \
